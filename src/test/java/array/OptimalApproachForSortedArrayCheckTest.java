...
import main.java.array.OptimalApproachForSortedArrayCheck;
...
public class OptimalApproachForSortedArrayCheckTest {

    OptimalApproachForSortedArrayCheck sortedBruteApproach;

    @BeforeEach
    void setup(){
        sortedBruteApproach = new OptimalApproachForSortedArrayCheck();
    }
